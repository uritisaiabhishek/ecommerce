        ...
        if($type=='delete'){
            ...
            if($query_run)
            {
                while($row=mysqli_fetch_assoc($query_run)){
                    $delete_banner_image=$row['cat_image'];
                    $file= CATEGORY_IMAGE_SERVER_PATH.$delete_banner_image;
                    unlink($file);
                                        ...
                                        <?php
                                            ...
                                            while($row=mysqli_fetch_assoc($res)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="<?php echo CATEGORY_IMAGE_SITE_PATH.$row['cat_image'] ?>" alt="<?php echo $row['categories'] ?>">
                                                    </td>
                                                    <td>
                                                        <?php 
                                                            if($row['status']==1){
                                                    ...
                                                    <td>
                                                        <?php
                                                            echo "<a class='btn btn-sm btn-primary' href='addCategory.php?id=".$row['id']."'>Edit</a>";
                                                        ?> 
                                                    </td>
                                                    <td>
                                                        <?php
