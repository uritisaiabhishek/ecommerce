<?php 
    ...
    if(isset($_GET['type']) && $_GET['type']!=''){
        ...
        if($type=='status'){
            ...
            $update_status_sql="update blog_categories set status='$status' where id='$id' ";
            mysqli_query($con,$update_status_sql);
        }
        if($type=='delete'){
            $id=get_safe_value($con,$_GET['id']);
            $check_sql_blog="select blog_category_id from blog where blog_category_id='$id' ";
            
            if(mysqli_num_rows(mysqli_query($con,$check_sql_blog))){
                                        ...
                                        <?php
                                            ...
                                            while($row=mysqli_fetch_assoc($res)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                            echo "<a class='btn btn-sm btn-primary' href='addBlogCategory.php?id=".$row['id']."'>Edit</a>";
                                                        ?> 
                                                    </td>
                                                    <td>
                                                        <?php
